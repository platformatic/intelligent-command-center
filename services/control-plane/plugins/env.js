...
const schema = {
  ...
  properties: {
    ...
    PLT_COMPLIANCE_URL: { type: 'string', default: 'http://compliance.plt.local' },
    ...
    PLT_APPLICATIONS_ELASTICACHE_SECRET_KEY: { type: 'string' },
    PLT_APPLICATIONS_ELASTICACHE_CLUSTERID_PREFIX: { type: 'string' },
    ...
    PLT_SKEW_CONFIRM_INTERVAL_MS: { type: 'number', default: 5000 },
