...
module.exports = fp(async function (app) {
  const {
    PLT_TRAFFICANTE_RECOMMENDATION_SCORE_THRESHOLD: SCORE_THRESHOLD,
    PLT_TRAFFICANTE_RECOMMENDATION_HISTORY_LENGTH: HISTORY_LENGTH,
    PLT_TRAFFICANTE_RECOMMENDATION_DECAY_FACTOR: DECAY_FACTOR,
    PLT_TRAFFICANTE_RECOMMENDATION_EXPECTED_IDS: EXPECTED_IDS,
    PLT_TRAFFICANTE_RECOMMENDATION_HISTORY_WEIGHT: HISTORY_WEIGHT,
    PLT_TRAFFICANTE_RECOMMENDATION_PAST_SCORE_WEIGHT: PAST_SCORE_WEIGHT,
    PLT_TRAFFICANTE_RECOMMENDATION_SCALE_FACTOR: SCALE_FACTOR,
    PLT_TRAFFICANTE_RECOMMENDATION_SCALE_SIGMA: SCALE_SIGMA,
    PLT_TRAFFICANTE_RECOMMENDATION_BASE_TTL: BASE_TTL,
    PLT_TRAFFICANTE_RECOMMENDATION_MIN_TTL: MIN_TTL,
    PLT_TRAFFICANTE_RECOMMENDATION_MAX_TTL: MAX_TTL
  } = app.env
