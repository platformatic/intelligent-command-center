...
(this.define || function (R, U) { this.sourceMapSupport = U() })('browser-source-map-support', function (R) {
  (function e (C, J, A) { function p (f, c) { if (!J[f]) { if (!C[f]) { var l = typeof require === 'function' && require; if (!c && l) return l(f, !0); if (t) return t(f, !0); throw Error("Cannot find module '" + f + "'") }l = J[f] = { exports: {} }; C[f][0].call(l.exports, function (q) { const r = C[f][1][q]; return p(r || q) }, l, l.exports, e, C, J, A) } return J[f].exports } for (var t = typeof require === 'function' && require, m = 0; m < A.length; m++)p(A[m]); return p })({
    1: [function (C,
      J, A) { R = C('./source-map-support') }, { './source-map-support': 21 }],
    2: [function (C, J, A) {
      (function (e) {
        function p (m) { m = m.charCodeAt(0); if (m === 43) return 62; if (m === 47) return 63; if (m < 48) return -1; if (m < 58) return m - 48 + 52; if (m < 91) return m - 65; if (m < 123) return m - 97 + 26 } const t = typeof Uint8Array !== 'undefined' ? Uint8Array : Array; e.toByteArray = function (m) {
          function f (d) { q[k++] = d } if (m.length % 4 > 0) throw Error('Invalid string. Length must be a multiple of 4'); let c = m.length; const l = m.charAt(c - 2) === '=' ? 2 : m.charAt(c - 1) === '=' ? 1 : 0; var q =
  new t(3 * m.length / 4 - l); const r = l > 0 ? m.length - 4 : m.length; var k = 0; for (c = 0; c < r; c += 4) { var u = p(m.charAt(c)) << 18 | p(m.charAt(c + 1)) << 12 | p(m.charAt(c + 2)) << 6 | p(m.charAt(c + 3)); f((u & 16711680) >> 16); f((u & 65280) >> 8); f(u & 255) }l === 2 ? (u = p(m.charAt(c)) << 2 | p(m.charAt(c + 1)) >> 4, f(u & 255)) : l === 1 && (u = p(m.charAt(c)) << 10 | p(m.charAt(c + 1)) << 4 | p(m.charAt(c + 2)) >> 2, f(u >> 8 & 255), f(u & 255)); return q
        }; e.fromByteArray = function (m) {
          const f = m.length % 3; let c = ''; let l; let q = 0; for (l = m.length - f; q < l; q += 3) {
  ...
  m[m.length - 1], c += 'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/'.charAt(r >> 10), c += 'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/'.charAt(r >> 4 & 63), c += 'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/'.charAt(r << 2 & 63), c += '='
      ...
      })(typeof A === 'undefined' ? this.base64js = {} : A)
    }, {}],
    3: [function (C, J, A) {}, {}],
    4: [function (C, J, A) {
      (function (e) {
        const p = Object.prototype.toString; const t = typeof e.alloc === 'function' && typeof e.allocUnsafe === 'function' && typeof e.from ===
  'function'; J.exports = function (m, f, c) {
          if (typeof m === 'number') throw new TypeError('"value" argument must not be a number'); if (p.call(m).slice(8, -1) === 'ArrayBuffer') { f >>>= 0; const l = m.byteLength - f; if (l < 0) throw new RangeError("'offset' is out of bounds"); if (void 0 === c)c = l; else if (c >>>= 0, c > l) throw new RangeError("'length' is out of bounds"); return t ? e.from(m.slice(f, f + c)) : new e(new Uint8Array(m.slice(f, f + c))) } if (typeof m === 'string') {
            c = f; if (typeof c !== 'string' || c === '')c = 'utf8'; if (!e.isEncoding(c)) throw new TypeError('"encoding" must be a valid string encoding')
    ...
    5: [function (C, J, A) {
      function e (a, b, h) {
        if (!(this instanceof e)) return new e(a, b, h); const w = typeof a; if (w === 'number') var y = a > 0 ? a >>> 0 : 0; else if (w === 'string') { if (b === 'base64') for (a = (a.trim ? a.trim() : a.replace(/^\s+|\s+$/g, '')).replace(L, ''); a.length % 4 !== 0;)a += '='; y = e.byteLength(a, b) } else if (w === 'object' && a !== null)a.type === 'Buffer' && z(a.data) && (a = a.data), y = +a.length > 0 ? Math.floor(+a.length) : 0; else throw new TypeError('must start with number, buffer, array or string')
        if (this.length > G) throw new RangeError('Attempt to allocate Buffer larger than maximum size: 0x' + G.toString(16) + ' bytes'); if (e.TYPED_ARRAY_SUPPORT) var I = e._augment(new Uint8Array(y)); else I = this, I.length = y, I._isBuffer = !0; if (e.TYPED_ARRAY_SUPPORT && typeof a.byteLength === 'number')I._set(a); else {
          const K = a; if (z(K) || e.isBuffer(K) || K && typeof K === 'object' && typeof K.length === 'number') if (e.isBuffer(a)) for (b = 0; b < y; b++)I[b] = a.readUInt8(b); else for (b = 0; b < y; b++)I[b] = (a[b] % 256 + 256) % 256; else if (w === 'string') {
            I.write(a,
              0, b)
          } else if (w === 'number' && !e.TYPED_ARRAY_SUPPORT && !h) for (b = 0; b < y; b++)I[b] = 0
        } return I
        ...
        y && (w -= w % y); for (y = 0; y < w && !(y + h >= b.length || y >= a.length); y++) {
          b[y +
  h] = a[y]
        } return y
      } function g (a) { try { return decodeURIComponent(a) } catch (b) { return String.fromCharCode(65533) } } const n = C('base64-js'); var v = C('ieee754'); var z = C('is-array'); A.Buffer = e; A.SlowBuffer = e; A.INSPECT_MAX_BYTES = 50; e.poolSize = 8192; var G = 1073741823; e.TYPED_ARRAY_SUPPORT = (function () { try { const a = new ArrayBuffer(0); const b = new Uint8Array(a); b.foo = function () { return 42 }; return b.foo() === 42 && typeof b.subarray === 'function' && (new Uint8Array(1)).subarray(1, 1).byteLength === 0 } catch (h) { return !1 } }()); e.isBuffer = function (a) {
        return !(a ==
  null || !a._isBuffer)
        ...
        if (a.length === 0) return new e(0); if (a.length === 1) return a[0]; let h; if (void 0 === b) for (h = b = 0; h < a.length; h++)b += a[h].length; const w = new e(b); let y = 0; for (h = 0; h < a.length; h++) { const I = a[h]; I.copy(w, y); y += I.length } return w
        ...
        let w = !1; b >>>= 0; h = void 0 === h || Infinity === h ? this.length : h >>> 0; a || (a = 'utf8'); b < 0 && (b = 0); h > this.length && (h = this.length); if (h <= b) return ''; for (;;) {
          switch (a) {
            case 'hex':a = b; b = h; h = this.length; if (!a || a < 0)a = 0; if (!b || b < 0 || b > h)b = h; w = ''; for (h = a; h < b; h++)a = w, w = this[h], w = w < 16 ? '0' + w.toString(16) : w.toString(16), w = a + w; return w; case 'utf8':case 'utf-8':w = a = ''; for (h = Math.min(this.length, h); b < h; b++) {
              this[b] <=
  127
                ? (a += g(w) + String.fromCharCode(this[b]), w = '')
                : w += '%' + this[b].toString(16)
            } return a + g(w); case 'ascii':return p(this, b, h); case 'binary':return p(this, b, h); case 'base64':return b = b === 0 && h === this.length ? n.fromByteArray(this) : n.fromByteArray(this.slice(b, h)), b; case 'ucs2':case 'ucs-2':case 'utf16le':case 'utf-16le':b = this.slice(b, h); h = ''; for (a = 0; a < b.length; a += 2)h += String.fromCharCode(b[a] + 256 * b[a + 1]); return h; default:if (w) throw new TypeError('Unknown encoding: ' + a); a = (a + '').toLowerCase(); w = !0
          }
        }
      }
      e.prototype.equals = function (a) { if (!e.isBuffer(a)) throw new TypeError('Argument must be a Buffer'); return e.compare(this, a) === 0 }; e.prototype.inspect = function () { let a = ''; const b = A.INSPECT_MAX_BYTES; this.length > 0 && (a = this.toString('hex', 0, b).match(/.{2}/g).join(' '), this.length > b && (a += ' ... ')); return '<Buffer ' + a + '>' }; e.prototype.compare = function (a) { if (!e.isBuffer(a)) throw new TypeError('Argument must be a Buffer'); return e.compare(this, a) }; e.prototype.get = function (a) {
  ...
  function (a, b) { b || t(a, 2, this.length); return this[a] | this[a + 1] << 8 }; e.prototype.readUInt16BE = function (a, b) { b || t(a, 2, this.length); return this[a] << 8 | this[a + 1] }; e.prototype.readUInt32LE = function (a, b) { b || t(a, 4, this.length); return (this[a] | this[a + 1] << 8 | this[a + 2] << 16) + 16777216 * this[a + 3] }; e.prototype.readUInt32BE = function (a, b) { b || t(a, 4, this.length); return 16777216 * this[a] + (this[a + 1] << 16 | this[a + 2] << 8 | this[a + 3]) }; e.prototype.readInt8 = function (a, b) { b || t(a, 1, this.length); return this[a] & 128 ? -1 * (255 - this[a] + 1) : this[a] }
      e.prototype.readInt16LE = function (a, b) { b || t(a, 2, this.length); const h = this[a] | this[a + 1] << 8; return h & 32768 ? h | 4294901760 : h }; e.prototype.readInt16BE = function (a, b) { b || t(a, 2, this.length); const h = this[a + 1] | this[a] << 8; return h & 32768 ? h | 4294901760 : h }; e.prototype.readInt32LE = function (a, b) { b || t(a, 4, this.length); return this[a] | this[a + 1] << 8 | this[a + 2] << 16 | this[a + 3] << 24 }; e.prototype.readInt32BE = function (a, b) { b || t(a, 4, this.length); return this[a] << 24 | this[a + 1] << 16 | this[a + 2] << 8 | this[a + 3] }; e.prototype.readFloatLE = function (a,
  ...
  2] = a >>> 8, this[b + 3] = a)
        ...
        a || (a = 0); b || (b = 0); h || (h = this.length); if (h < b) throw new TypeError('end < start'); if (h !== b && this.length !== 0) {
          ...
          if (h < 0 || h > this.length) throw new TypeError('end out of bounds'); if (typeof a === 'number') for (;b < h; b++) this[b] = a; else { a = k(a.toString()); for (let w = a.length; b < h; b++) this[b] = a[b % w] } return this
        }
      }; e.prototype.toArrayBuffer = function () { if (typeof Uint8Array !== 'undefined') { if (e.TYPED_ARRAY_SUPPORT) return (new e(this)).buffer; for (var a = new Uint8Array(this.length), b = 0, h = a.length; b < h; b += 1)a[b] = this[b]; return a.buffer } throw new TypeError('Buffer.toArrayBuffer not supported in this browser') }; const D = e.prototype; e._augment =
  function (a) {
  ...
  D.writeDoubleLE; a.writeDoubleBE = D.writeDoubleBE; a.fill = D.fill; a.inspect = D.inspect; a.toArrayBuffer = D.toArrayBuffer; return a
    ...
    6: [function (C, J, A) {
      A.read = function (e, p, t, m, f) {
        let c = 8 * f - m - 1; const l = (1 << c) - 1; const q = l >> 1; let r = -7; f = t ? f - 1 : 0; const k = t ? -1 : 1; let u = e[p + f]; f += k; t = u & (1 << -r) - 1; u >>= -r; for (r += c; r > 0; t = 256 * t + e[p + f], f += k, r -= 8);c = t & (1 << -r) - 1; t >>= -r; for (r += m; r > 0; c = 256 * c + e[p + f], f += k, r -= 8);if (t === 0)t = 1 - q; else {
          if (t === l) return c ? NaN : Infinity * (u ? -1 : 1); c += Math.pow(2,
            m); t -= q
        } return (u ? -1 : 1) * c * Math.pow(2, t - m)
      }; A.write = function (e, p, t, m, f, c) {
        let l; let q = 8 * c - f - 1; const r = (1 << q) - 1; const k = r >> 1; const u = f === 23 ? Math.pow(2, -24) - Math.pow(2, -77) : 0; c = m ? 0 : c - 1; const d = m ? 1 : -1; const g = p < 0 || p === 0 && 1 / p < 0 ? 1 : 0; p = Math.abs(p); isNaN(p) || Infinity === p ? (p = isNaN(p) ? 1 : 0, m = r) : (m = Math.floor(Math.log(p) / Math.LN2), p * (l = Math.pow(2, -m)) < 1 && (m--, l *= 2), p = m + k >= 1 ? p + u / l : p + u * Math.pow(2, 1 - k), p * l >= 2 && (m++, l /= 2), m + k >= r ? (p = 0, m = r) : m + k >= 1 ? (p = (p * l - 1) * Math.pow(2, f), m += k) : (p = p * Math.pow(2, k - 1) * Math.pow(2, f), m = 0)); for (;f >= 8; e[t + c] = p & 255, c +=
  d, p /= 256, f -= 8);m = m << f | p; for (q += f; q > 0; e[t + c] = m & 255, c += d, m /= 256, q -= 8);e[t + c - d] |= 128 * g
      }
    }, {}],
    7: [function (C, J, A) { const e = Object.prototype.toString; J.exports = Array.isArray || function (p) { return !!p && e.call(p) == '[object Array]' } }, {}],
    8: [function (C, J, A) {
      (function (e) {
        function p (c, l) { for (var q = 0, r = c.length - 1; r >= 0; r--) { const k = c[r]; k === '.' ? c.splice(r, 1) : k === '..' ? (c.splice(r, 1), q++) : q && (c.splice(r, 1), q--) } if (l) for (;q--; q)c.unshift('..'); return c } function t (c, l) {
          if (c.filter) return c.filter(l); for (var q = [], r = 0; r < c.length; r++) {
            l(c[r],
              r, c) && q.push(c[r])
          } return q
        } const m = /^(\/?|)([\s\S]*?)((?:\.{1,2}|[^\/]+?|)(\.[^.\/]*|))(?:[\/]*)$/; A.resolve = function () { for (var c = '', l = !1, q = arguments.length - 1; q >= -1 && !l; q--) { const r = q >= 0 ? arguments[q] : e.cwd(); if (typeof r !== 'string') throw new TypeError('Arguments to path.resolve must be strings'); r && (c = r + '/' + c, l = r.charAt(0) === '/') }c = p(t(c.split('/'), function (k) { return !!k }), !l).join('/'); return (l ? '/' : '') + c || '.' }; A.normalize = function (c) {
          const l = A.isAbsolute(c); const q = f(c, -1) === '/'; (c = p(t(c.split('/'), function (r) { return !!r }),
            !l).join('/')) || l || (c = '.'); c && q && (c += '/'); return (l ? '/' : '') + c
        }; A.isAbsolute = function (c) { return c.charAt(0) === '/' }; A.join = function () { const c = Array.prototype.slice.call(arguments, 0); return A.normalize(t(c, function (l, q) { if (typeof l !== 'string') throw new TypeError('Arguments to path.join must be strings'); return l }).join('/')) }; A.relative = function (c, l) {
        ...
        var f = 'ab'.substr(-1) === 'b' ? function (c, l, q) { return c.substr(l, q) } : function (c, l, q) { l < 0 && (l = c.length + l); return c.substr(l, q) }
      }).call(this, C('g5I+bs'))
    }, { 'g5I+bs': 9 }],
    9: [function (C, J, A) {
      function e () {}C = J.exports = {}; C.nextTick = (function () {
        if (typeof window !== 'undefined' && window.setImmediate) return function (t) { return window.setImmediate(t) }; if (typeof window !== 'undefined' && window.postMessage && window.addEventListener) {
          const p = []; window.addEventListener('message', function (t) {
            const m = t.source; m !== window && m !==
  null || t.data !== 'process-tick' || (t.stopPropagation(), p.length > 0 && p.shift()())
          }, !0); return function (t) { p.push(t); window.postMessage('process-tick', '*') }
        } return function (t) { setTimeout(t, 0) }
      }()); C.title = 'browser'; C.browser = !0; C.env = {}; C.argv = []; C.on = e; C.addListener = e; C.once = e; C.off = e; C.removeListener = e; C.removeAllListeners = e; C.emit = e; C.binding = function (p) { throw Error('process.binding is not supported') }; C.cwd = function () { return '/' }; C.chdir = function (p) { throw Error('process.chdir is not supported') }
    }, {}],
    10: [function (C, J, A) {
      function e () { this._array = []; this._set = m ? new Map() : Object.create(null) } const p = C('./util'); const t = Object.prototype.hasOwnProperty; var m = typeof Map !== 'undefined'; e.fromArray = function (f, c) { for (var l = new e(), q = 0, r = f.length; q < r; q++)l.add(f[q], c); return l }; e.prototype.size = function () { return m ? this._set.size : Object.getOwnPropertyNames(this._set).length }; e.prototype.add = function (f, c) {
        const l = m ? f : p.toSetString(f); const q = m ? this.has(f) : t.call(this._set, l); const r = this._array.length; q && !c || this._array.push(f); q || (m
          ? this._set.set(f, r)
          : this._set[l] = r)
    ...
    11: [function (C, J, A) { const e = C('./base64'); A.encode = function (p) { let t = ''; let m = p < 0 ? (-p << 1) + 1 : p << 1; do p = m & 31, m >>>= 5, m > 0 && (p |= 32), t += e.encode(p); while (m > 0); return t }; A.decode = function (p, t, m) { const f = p.length; let c = 0; let l = 0; do { if (t >= f) throw Error('Expected more digits in base 64 VLQ value.'); let q = e.decode(p.charCodeAt(t++)); if (q === -1) throw Error('Invalid base64 digit: ' + p.charAt(t - 1)); var r = !!(q & 32); q &= 31; c += q << l; l += 5 } while (r); p = c >> 1; m.value = (c & 1) === 1 ? -p : p; m.rest = t } }, { './base64': 12 }],
    12: [function (C,
      J, A) { const e = 'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/'.split(''); A.encode = function (p) { if (p >= 0 && p < e.length) return e[p]; throw new TypeError('Must be between 0 and 63: ' + p) }; A.decode = function (p) { return p >= 65 && p <= 90 ? p - 65 : p >= 97 && p <= 122 ? p - 97 + 26 : p >= 48 && p <= 57 ? p - 48 + 52 : p == 43 ? 62 : p == 47 ? 63 : -1 } }, {}],
    13: [function (C, J, A) {
      function e (p, t, m, f, c, l) {
        const q = Math.floor((t - p) / 2) + p; const r = c(m, f[q], !0); return r === 0
          ? q
          : r > 0
  ...
  A.LEAST_UPPER_BOUND
    ...
    14: [function (C, J, A) {
      function e () { this._array = []; this._sorted = !0; this._last = { generatedLine: -1, generatedColumn: 0 } } const p = C('./util'); e.prototype.unsortedForEach = function (t, m) { this._array.forEach(t, m) }; e.prototype.add = function (t) {
        const m = this._last; const f = m.generatedLine
        const c = t.generatedLine; const l = m.generatedColumn; const q = t.generatedColumn; c > f || c == f && q >= l || p.compareByGeneratedPositionsInflated(m, t) <= 0 ? this._last = t : this._sorted = !1; this._array.push(t)
    ...
    15: [function (C, J, A) {
      function e (t, m, f) { const c = t[m]; t[m] = t[f]; t[f] = c } function p (t, m, f, c) {
        if (f < c) {
    ...
    16: [function (C, J, A) {
      function e (k, u) { let d = k; typeof k === 'string' && (d = f.parseSourceMapInput(k)); return d.sections != null ? new m(d, u) : new p(d, u) } function p (k, u) {
        let d = k; typeof k === 'string' && (d = f.parseSourceMapInput(k)); const g = f.getArg(d, 'version'); let n = f.getArg(d, 'sources'); const v = f.getArg(d, 'names', []); let z = f.getArg(d, 'sourceRoot', null); const G = f.getArg(d, 'sourcesContent', null); const D = f.getArg(d,
  ...
  null
        ...
        let d = k; typeof k === 'string' && (d = f.parseSourceMapInput(k)); const g = f.getArg(d, 'version'); d = f.getArg(d, 'sections'); if (g != this._version) throw Error('Unsupported version: ' + g); this._sources = new l(); this._names = new l(); let n = { line: -1, column: 0 }; this._sections = d.map(function (v) {
          if (v.url) throw Error('Support for url field in sections not implemented.'); const z = f.getArg(v, 'offset'); const G = f.getArg(z, 'line'); const D = f.getArg(z, 'column'); if (G < n.line || G === n.line && D < n.column) throw Error('Section offsets must be ordered and non-overlapping.')
          n = z; return { generatedOffset: { generatedLine: G + 1, generatedColumn: D + 1 }, consumer: new e(f.getArg(v, 'map'), u) }
        })
      } var f = C('./util'); const c = C('./binary-search'); var l = C('./array-set').ArraySet; const q = C('./base64-vlq'); const r = C('./quick-sort').quickSort; e.fromSourceMap = function (k) { return p.fromSourceMap(k) }; e.prototype._version = 3; e.prototype.__generatedMappings = null; Object.defineProperty(e.prototype, '_generatedMappings', {
        configurable: !0,
        enumerable: !0,
        get: function () {
      ...
      }); e.prototype.__originalMappings = null; Object.defineProperty(e.prototype, '_originalMappings', { configurable: !0, enumerable: !0, get: function () { this.__originalMappings || this._parseMappings(this._mappings, this.sourceRoot); return this.__originalMappings } }); e.prototype._charIsMappingSeparator = function (k, u) { const d = k.charAt(u); return d === ';' || d === ',' }; e.prototype._parseMappings = function (k, u) { throw Error('Subclasses must implement _parseMappings') }; e.GENERATED_ORDER =
  1; e.ORIGINAL_ORDER = 2; e.GREATEST_LOWER_BOUND = 1; e.LEAST_UPPER_BOUND = 2; e.prototype.eachMapping = function (k, u, d) {
        u = u || null; switch (d || e.GENERATED_ORDER) { case e.GENERATED_ORDER:d = this._generatedMappings; break; case e.ORIGINAL_ORDER:d = this._originalMappings; break; default:throw Error('Unknown order of iteration.') } const g = this.sourceRoot; d.map(function (n) {
        ...
        let u = f.getArg(k, 'line'); let d = { source: f.getArg(k, 'source'), originalLine: u, originalColumn: f.getArg(k, 'column', 0) }; this.sourceRoot != null && (d.source = f.relative(this.sourceRoot, d.source)); if (!this._sources.has(d.source)) return []; d.source = this._sources.indexOf(d.source); const g = []; d = this._findMapping(d, this._originalMappings, 'originalLine',
          'originalColumn', f.compareByOriginalPositions, c.LEAST_UPPER_BOUND); if (d >= 0) {
          let n = this._originalMappings[d]; if (void 0 === k.column) for (u = n.originalLine; n && n.originalLine === u;)g.push({ line: f.getArg(n, 'generatedLine', null), column: f.getArg(n, 'generatedColumn', null), lastColumn: f.getArg(n, 'lastGeneratedColumn', null) }), n = this._originalMappings[++d]; else {
            for (k = n.originalColumn; n && n.originalLine === u && n.originalColumn == k;) {
              g.push({
        ...
        for (var d = 1, g = 0, n = 0, v = 0, z = 0, G = 0, D = k.length, L = 0, a = {}, b = {}, h = [], w = [], y, I, K, N, P; L < D;) {
          if (k.charAt(L) === ';')d++, L++, g = 0; else if (k.charAt(L) === ',')L++; else {
            y = new t(); y.generatedLine = d; for (N = L; N < D && !this._charIsMappingSeparator(k, N); N++);I = k.slice(L, N); if (K = a[I])L += I.length; else {
              for (K = []; L < N;)q.decode(k, L, b), P = b.value, L = b.rest, K.push(P); if (K.length === 2) throw Error('Found a source, but no line and column'); if (K.length === 3) throw Error('Found a source and line, but no column')
              a[I] = K
            }y.generatedColumn = g + K[0]; g = y.generatedColumn; K.length > 1 && (y.source = z + K[1], z += K[1], y.originalLine = n + K[2], n = y.originalLine, y.originalLine += 1, y.originalColumn = v + K[3], v = y.originalColumn, K.length > 4 && (y.name = G + K[4], G += K[4])); w.push(y); typeof y.originalLine === 'number' && h.push(y)
          }
        }r(w, f.compareByGeneratedPositionsDeflated); this.__generatedMappings = w; r(h, f.compareByOriginalPositions); this.__originalMappings = h
      }; p.prototype._findMapping = function (k, u, d, g, n, v) {
        if (k[d] <= 0) {
          throw new TypeError('Line must be greater than or equal to 1, got ' +
  k[d])
        } if (k[g] < 0) throw new TypeError('Column must be greater than or equal to 0, got ' + k[g]); return c.search(k, u, n, v)
      }; p.prototype.computeColumnSpans = function () { for (let k = 0; k < this._generatedMappings.length; ++k) { const u = this._generatedMappings[k]; if (k + 1 < this._generatedMappings.length) { const d = this._generatedMappings[k + 1]; if (u.generatedLine === d.generatedLine) { u.lastGeneratedColumn = d.generatedColumn - 1; continue } }u.lastGeneratedColumn = Infinity } }; p.prototype.originalPositionFor = function (k) {
        let u = {
        ...
        let g = this.sources; let n; for (n = 0; n < g.length; ++n) if (g[n] == k) return this.sourcesContent[n]; let v; if (this.sourceRoot != null && (v = f.urlParse(this.sourceRoot))) { g = d.replace(/^file:\/\//, ''); if (v.scheme == 'file' && this._sources.has(g)) return this.sourcesContent[this._sources.indexOf(g)]; if ((!v.path || v.path == '/') && this._sources.has('/' + d)) return this.sourcesContent[this._sources.indexOf('/' + d)] } if (u) return null; throw Error('"' + d + '" is not in the SourceMap.')
  ...
  function (k) {
    const u = { generatedLine: f.getArg(k, 'line'), generatedColumn: f.getArg(k, 'column') }; let d = c.search(u, this._sections, function (g, n) { const v = g.generatedLine - n.generatedOffset.generatedLine; return v || g.generatedColumn - n.generatedOffset.generatedColumn }); return (d = this._sections[d])
  ...
  }; m.prototype.hasContentsOfAllSources = function () { return this._sections.every(function (k) { return k.consumer.hasContentsOfAllSources() }) }; m.prototype.sourceContentFor = function (k, u) { for (let d = 0; d < this._sections.length; d++) { const g = this._sections[d].consumer.sourceContentFor(k, !0); if (g) return g } if (u) return null; throw Error('"' + k + '" is not in the SourceMap.') }; m.prototype.generatedPositionFor = function (k) {
        for (let u = 0; u < this._sections.length; u++) {
          const d = this._sections[u]; if (d.consumer.sources.indexOf(f.getArg(k, 'source')) !==
  -1) { const g = d.consumer.generatedPositionFor(k); if (g) return { line: g.line + (d.generatedOffset.generatedLine - 1), column: g.column + (d.generatedOffset.generatedLine === g.line ? d.generatedOffset.generatedColumn - 1 : 0) } }
        } return { line: null, column: null }
      }; m.prototype._parseMappings = function (k, u) {
        this.__generatedMappings = []; this.__originalMappings = []; for (let d = 0; d < this._sections.length; d++) {
          for (let g = this._sections[d], n = g.consumer._generatedMappings, v = 0; v < n.length; v++) {
            let z =
  n[v]; let G = g.consumer._sources.at(z.source); G = f.computeSourceURL(g.consumer.sourceRoot, G, this._sourceMapURL); this._sources.add(G); G = this._sources.indexOf(G); let D = null; z.name && (D = g.consumer._names.at(z.name), this._names.add(D), D = this._names.indexOf(D)); z = {
              source: G,
        ...
        }r(this.__generatedMappings, f.compareByGeneratedPositionsDeflated); r(this.__originalMappings, f.compareByOriginalPositions)
    ...
    17: [function (C, J, A) {
      function e (c) {
      ...
      } const p = C('./base64-vlq'); var t = C('./util'); var m = C('./array-set').ArraySet; var f = C('./mapping-list').MappingList; e.prototype._version = 3; e.fromSourceMap = function (c) {
        const l = c.sourceRoot; const q = new e({ file: c.file, sourceRoot: l }); c.eachMapping(function (r) {
          const k = { generated: { line: r.generatedLine, column: r.generatedColumn } }; r.source != null && (k.source = r.source, l != null && (k.source = t.relative(l, k.source)), k.original = {
            line: r.originalLine,
        ...
        const l = t.getArg(c, 'generated'); const q = t.getArg(c, 'original', null); let r = t.getArg(c, 'source', null); c = t.getArg(c, 'name', null); this._skipValidation || this._validateMapping(l, q, r, c); r != null && (r = String(r), this._sources.has(r) || this._sources.add(r))
        c != null && (c = String(c), this._names.has(c) || this._names.add(c)); this._mappings.add({ generatedLine: l.line, generatedColumn: l.column, originalLine: q != null && q.line, originalColumn: q != null && q.column, source: r, name: c })
        ...
        }, this); this._sources = u; this._names = d; c.sources.forEach(function (g) { const n = c.sourceContentFor(g); n != null && (q != null && (g = t.join(q, g)), k != null && (g = t.relative(k, g)), this.setSourceContent(g, n)) }, this)
  ...
  q)) throw Error('Invalid mapping: ' + JSON.stringify({ generated: c, source: q, original: l, name: r }))
  ...
  []; this.sourceContents = {}; this.line = f == null ? null : f; this.column = c == null ? null : c; this.source = l == null ? null : l; this.name = r == null ? null : r; this.$$$isSourceNode$$$ = !0; q != null && this.add(q)
      } const p = C('./source-map-generator').SourceMapGenerator; const t = C('./util'); const m = /(\r?\n)/; e.fromStringWithSourceMap = function (f, c, l) {
        function q (z, G) { if (z === null || void 0 === z.source)r.add(G); else { const D = l ? t.join(l, z.source) : z.source; r.add(new e(z.originalLine, z.originalColumn, D, G, z.name)) } } var r = new e(); const k = f.split(m); let u = 0; const d = function () {
          const z =
  u < k.length ? k[u++] : void 0; const G = (u < k.length ? k[u++] : void 0) || ''; return z + G
        }; let g = 1; let n = 0; let v = null; c.eachMapping(function (z) { if (v !== null) if (g < z.generatedLine)q(v, d()), g++, n = 0; else { var G = k[u] || ''; const D = G.substr(0, z.generatedColumn - n); k[u] = G.substr(z.generatedColumn - n); n = z.generatedColumn; q(v, D); v = z; return } for (;g < z.generatedLine;)r.add(d()), g++; n < z.generatedColumn && (G = k[u] || '', r.add(G.substr(0, z.generatedColumn)), k[u] = G.substr(z.generatedColumn), n = z.generatedColumn); v = z }, this); u < k.length && (v && q(v, d()), r.add(k.splice(u).join('')))
        c.sources.forEach(function (z) { const G = c.sourceContentFor(z); G != null && (l != null && (z = t.join(l, z)), r.setSourceContent(z, G)) }); return r
      }; e.prototype.add = function (f) { if (Array.isArray(f))f.forEach(function (c) { this.add(c) }, this); else if (f.$$$isSourceNode$$$ || typeof f === 'string')f && this.children.push(f); else throw new TypeError('Expected a SourceNode, string, or an array of SourceNodes and strings. Got ' + f); return this }; e.prototype.prepend = function (f) {
        if (Array.isArray(f)) for (let c = f.length - 1; c >= 0; c--) this.prepend(f[c])
        else if (f.$$$isSourceNode$$$ || typeof f === 'string') this.children.unshift(f); else throw new TypeError('Expected a SourceNode, string, or an array of SourceNodes and strings. Got ' + f); return this
        ...
        let c; const l = this.children.length; if (l > 0) {
          const q = []; for (c = 0; c < l - 1; c++) {
            q.push(this.children[c]),
            q.push(f)
          } q.push(this.children[c]); this.children = q
        } return this
      }; e.prototype.replaceRight = function (f, c) { const l = this.children[this.children.length - 1]; l.$$$isSourceNode$$$ ? l.replaceRight(f, c) : typeof l === 'string' ? this.children[this.children.length - 1] = l.replace(f, c) : this.children.push(''.replace(f, c)); return this }; e.prototype.setSourceContent = function (f, c) { this.sourceContents[t.toSetString(f)] = c }; e.prototype.walkSourceContents = function (f) {
        for (var c = 0, l = this.children.length; c < l; c++) {
          this.children[c].$$$isSourceNode$$$ &&
  this.children[c].walkSourceContents(f)
        } const q = Object.keys(this.sourceContents); c = 0; for (l = q.length; c < l; c++)f(t.fromSetString(q[c]), this.sourceContents[q[c]])
      }; e.prototype.toString = function () { let f = ''; this.walk(function (c) { f += c }); return f }; e.prototype.toStringWithSourceMap = function (f) {
        let c = ''; let l = 1; let q = 0; const r = new p(f); let k = !1; let u = null; let d = null; let g = null; let n = null; this.walk(function (v, z) {
    ...
    19: [function (C, J, A) {
      function e (d) { return (d = d.match(k)) ? { scheme: d[1], auth: d[2], host: d[3], port: d[4], path: d[5] } : null } function p (d) { let g = ''; d.scheme && (g += d.scheme + ':'); g += '//'; d.auth && (g += d.auth + '@'); d.host && (g += d.host); d.port && (g += ':' + d.port); d.path && (g += d.path); return g } function t (d) {
        let g = d; const n = e(d); if (n) { if (!n.path) return d; g = n.path }d = A.isAbsolute(g); g = g.split(/\/+/); for (var v, z = 0, G = g.length - 1; G >= 0; G--) {
          v = g[G], v === '.'
            ? g.splice(G, 1)
            : v === '..'
              ? z++
              : z > 0 && (v === ''
                ...
                : (g.splice(G,
                    2), z--))
        } g = g.join('/'); g === '' && (g = d ? '/' : '.'); return n ? (n.path = g, p(n)) : g
      } function m (d, g) { d === '' && (d = '.'); g === '' && (g = '.'); let n = e(g); const v = e(d); v && (d = v.path || '/'); if (n && !n.scheme) return v && (n.scheme = v.scheme), p(n); if (n || g.match(u)) return g; if (v && !v.host && !v.path) return v.host = g, p(v); n = g.charAt(0) === '/' ? g : t(d.replace(/\/+$/, '') + '/' + g); return v ? (v.path = n, p(v)) : n } function f (d) { return d } function c (d) { return q(d) ? '$' + d : d } function l (d) { return q(d) ? d.slice(1) : d } function q (d) {
  ...
  g.originalLine; if (v !== 0) return v; v = d.originalColumn - g.originalColumn; return v !== 0 ? v : r(d.name, g.name)
    ...
    21: [function (C, J, A) {
      (function (e) {
        function p () { return a === 'browser' ? !0 : a === 'node' ? !1 : typeof window !== 'undefined' && typeof XMLHttpRequest === 'function' && !(window.require && window.module && window.process && window.process.type === 'renderer') } function t (x) { return function (B) { for (let F = 0; F < x.length; F++) { const E = x[F](B); if (E) return E } return null } } function m (x, B) {
          if (!x) return B; const F = n.dirname(x); let E = /^\w+:\/\/[^\/]*/.exec(F); E = E ? E[0] : ''; const H = F.slice(E.length)
          return E && /^\/\w:/.test(H) ? (E += '/', E + n.resolve(F.slice(E.length), B).replace(/\\/g, '/')) : E + n.resolve(F.slice(E.length), B)
        } function f (x) {
          let B = h[x.source]; if (!B) { var F = N(x.source); F ? (B = h[x.source] = { url: F.url, map: new g(F.map) }, B.map.sourcesContent && B.map.sources.forEach(function (E, H) { const M = B.map.sourcesContent[H]; if (M) { const S = m(B.url, E); b[S] = M } })) : B = h[x.source] = { url: null, map: null } } return B && B.map && typeof B.map.originalPositionFor === 'function' && (F = B.map.originalPositionFor(x), F.source !== null)
            ? (F.source =
  m(B.url, F.source), F)
            : x
  ...
  this.getColumnNumber()) && (x += ':' + B))
          }B = ''; const F = this.getFunctionName(); let E = !0; let H = this.isConstructor(); if (this.isToplevel() || H)H ? B += 'new ' + (F || '<anonymous>') : F ? B += F : (B += x, E = !1); else { H = this.getTypeName(); H === '[object Object]' && (H = 'null'); const M = this.getMethodName(); F ? (H && F.indexOf(H) != 0 && (B += H + '.'), B += F, M && F.indexOf('.' + M) != F.length - M.length - 1 && (B += ' [as ' + M + ']')) : B += H + '.' + (M || '<anonymous>') }E && (B += ' (' + x + ')'); return B
        } function q (x) {
          const B = {}; Object.getOwnPropertyNames(Object.getPrototypeOf(x)).forEach(function (F) {
            B[F] =
  /^(?:is|get)/.test(F) ? function () { return x[F].call(x) } : x[F]
          }); B.toString = l; return B
        } function r (x, B) {
          void 0 === B && (B = { nextPosition: null, curPosition: null }); if (x.isNative()) return B.curPosition = null, x; const F = x.getFileName() || x.getScriptNameOrSourceURL(); if (F) {
            const E = x.getLineNumber(); let H = x.getColumnNumber() - 1; let M = /^v(10\.1[6-9]|10\.[2-9][0-9]|10\.[0-9]{3,}|1[2-9]\d*|[2-9]\d|\d{3,}|11\.11)/; const S = M.test; const V = typeof e === 'object' && e !== null ? e.version : ''; M = S.call(M, V) ? 0 : 62; E === 1 && H > M && !p() && !x.isEval() && (H -= M); const O =
  f({ source: F, line: E, column: H }); B.curPosition = O; x = q(x); const T = x.getFunctionName; x.getFunctionName = function () { return B.nextPosition == null ? T() : B.nextPosition.name || T() }; x.getFileName = function () { return O.source }; x.getLineNumber = function () { return O.line }; x.getColumnNumber = function () { return O.column + 1 }; x.getScriptNameOrSourceURL = function () { return O.source }; return x
  ...
  (x.name || 'Error') + ': ' + (x.message || ''), E = { nextPosition: null, curPosition: null }, H = [], M = B.length - 1; M >= 0; M--)H.push('\n    at ' + r(B[M], E)), E.nextPosition = E.curPosition; E.curPosition = E.nextPosition = null; return F + H.reverse().join('')
          ...
          let B = /\n {4}at [^(]+ \((.*):(\d+):(\d+)\)/.exec(x.stack); if (B) {
            x = B[1]; const F = +B[2]; B = +B[3]; let E = b[x]; if (!E && v && v.existsSync(x)) try { E = v.readFileSync(x, 'utf8') } catch (H) { E = '' } if (E && (E = E.split(/(?:\r\n|\r|\n)/)[F - 1])) {
              return x + ':' + F + '\n' + E + '\n' + Array(B).join(' ') +
  '^'
            }
          } return null
        } function d () { const x = e.emit; e.emit = function (B) { if (B === 'uncaughtException') { let F = arguments[1] && arguments[1].stack; let E = this.listeners(B).length > 0; if (F && !E) { F = arguments[1]; E = u(F); const H = typeof e === 'object' && e !== null ? e.stderr : void 0; H && H._handle && H._handle.setBlocking && H._handle.setBlocking(!0); E && (console.error(), console.error(E)); console.error(F.stack); typeof e === 'object' && e !== null && typeof e.exit === 'function' && e.exit(1); return } } return x.apply(this, arguments) } } var g = C('source-map').SourceMapConsumer
        var n = C('path'); try { var v = C('fs'); v.existsSync && v.readFileSync || (v = null) } catch (x) {} const z = C('buffer-from'); let G = !1; let D = !1; var L = !1; var a = 'auto'; var b = {}; var h = {}; const w = /^data:application\/json[^,]+base64,/; let y = []; let I = []; let K = t(y); y.push(function (x) {
          x = x.trim(); /^file:/.test(x) && (x = x.replace(/file:\/\/\/(\w:)?/, function (E, H) { return H ? '' : '/' })); if (x in b) return b[x]; let B = ''; try { if (v)v.existsSync(x) && (B = v.readFileSync(x, 'utf8')); else { const F = new XMLHttpRequest(); F.open('GET', x, !1); F.send(null); F.readyState === 4 && F.status === 200 && (B = F.responseText) } } catch (E) {} return b[x] =
  B
          ...
          a: { if (p()) try { var B = new XMLHttpRequest(); B.open('GET', x, !1); B.send(null); var F = B.getResponseHeader('SourceMap') || B.getResponseHeader('X-SourceMap'); if (F) { var E = F; break a } } catch (M) {}E = K(x); B = /(?:\/\/[@#][\s]*sourceMappingURL=([^\s'"]+)[\s]*$)|(?:\/\*[@#][\s]*sourceMappingURL=([^\s*'"]+)[\s]*(?:\*\/)[\s]*$)/mg; for (var H; F = B.exec(E);)H = F; E = H ? H[1] : null } if (!E) return null; w.test(E) ? (H = E.slice(E.indexOf(',') + 1), H = z(H, 'base64').toString(), E = x) : (E = m(x, E), H = K(E)); return H
            ...
            : null
        }); const P = y.slice(0); const W = I.slice(0); A.wrapCallSite = r; A.getErrorSource = u; A.mapSourcePosition = f; A.retrieveSourceMap = N; A.install = function (x) {
  ...
  !p()) { const B = J.require('module'); const F = B.prototype._compile; F.__sourceMapSupport || (B.prototype._compile = function (E, H) { b[H] = E; h[H] = void 0; return F.call(this, E, H) }, B.prototype._compile.__sourceMapSupport = !0) }L || (L = 'emptyCacheBetweenOperations' in x ? x.emptyCacheBetweenOperations : !1); G || (G = !0, Error.prepareStackTrace = k); if (!D) {
            x = 'handleUncaughtExceptions' in x ? x.handleUncaughtExceptions : !0; try { !1 === J.require('worker_threads').isMainThread && (x = !1) } catch (E) {}x && typeof e === 'object' && e !== null && typeof e.on === 'function' &&
  (D = !0, d())
          }
