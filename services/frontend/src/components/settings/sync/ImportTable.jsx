...
function Table ({
  ...
  function renderComponent () {
    ...
    const title = 'The data has never been imported'
    const icon = <Icons.ImportIcon color={WHITE} size={MEDIUM} />
      ...
      <BorderedBox color={TRANSPARENT} backgroundColor={BLACK_RUSSIAN} classes={styles.boxSynch}>
        <div className={styles.content}>
          <div className={styles.tableHeaders}>
            <div className={`${styles.tableHeader} ${gridStyles.colSpanMiddle2}`}>
              <div className={styles.thWithIcon}>
                <span className={`${typographyStyles.desktopOtherOverlineSmall} ${typographyStyles.textWhite} ${typographyStyles.opacity70}`}>Imported On (UTC)</span>
              </div>
            </div>
            <div className={`${styles.tableHeader} ${gridStyles.colSpanMiddle2}`}>
              <div className={styles.thWithIcon}>
            ...
            <div className={`${styles.tableHeader} ${gridStyles.colSpanMiddle2}`}>
              <div className={styles.thWithIcon}>
                <span className={`${typographyStyles.desktopOtherOverlineSmall} ${typographyStyles.textWhite} ${typographyStyles.opacity70}`}>Latest Data Imported at (UTC)</span>
              </div>
            </div>
            <div className={`${styles.tableHeader} ${gridStyles.colSpanMiddle2}`}>
              <div className={styles.thWithIcon}>
          ...
          <div className={styles.table}>
            ...
            {data.map(row => (
              <ImportRow
                key={row.id} {...row} onClickViewDetail={() => onViewDetail(row)}
              />
            ))}
