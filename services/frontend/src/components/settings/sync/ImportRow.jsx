...
function ImportRow ({
  ...
  const dateLabel = 'Imported On (UTC)'
  return (
    <div className={styles.row}>
      <div className={`${styles.tableSmallDescription} ${gridStyles.colSpanMiddle2}`}>
      ...
      <div className={`${styles.tableSmall} ${gridStyles.colSpanMiddle2}`}>
        <div className={styles.tableCell}>
          <span className={`${typographyStyles.desktopBodySmall} ${typographyStyles.textWhite} ${styles.ellipsis}`} />
        </div>
        <div className={styles.tableCell}>
          <div className={`${styles.customSmallFlexRow}`}>
      ...
      <div className={`${styles.tableSmall} ${gridStyles.colSpanMiddle2}`}>
        ...
        <div className={styles.tableCell}>
          <div className={`${styles.customSmallFlexRow}`}>
            <span className={`${typographyStyles.desktopBodySmall} ${typographyStyles.textWhite} `}>{getFormattedTimeAndDate(latestDataAcquiredAt)}</span>
          </div>
        </div>
      </div>
