...
import styles from './TableAutoscalerActivities.module.css'
import { LoadingSpinnerV2 } from '@platformatic/ui-components'
import RowAutoscalerActivity from './RowAutoscalerActivity'
import NoDataFound from '~/components/ui/NoDataFound'
import gridStyles from '~/styles/GridStyles.module.css'

function TableAutoscalerActivities ({
      ...
      <div className={styles.content}>
        <div className={styles.tableActivities}>
          ...
          {activities.map(activity => (
            <RowAutoscalerActivity key={activity.id} {...activity} onClickViewJSON={() => onClickViewJSON(activity)} />
          ))}
...
TableAutoscalerActivities.propTypes = {
  /**
   * activitiesLoaded
    */
...
export default TableAutoscalerActivities
