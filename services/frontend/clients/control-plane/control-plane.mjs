...
async function _getInstances (url, request) {
  const queryParameters = ['limit', 'offset', 'totalCount', 'fields', 'where.applicationId.eq', 'where.applicationId.neq', 'where.applicationId.gt', 'where.applicationId.gte', 'where.applicationId.lt', 'where.applicationId.lte', 'where.applicationId.like', 'where.applicationId.ilike', 'where.applicationId.in', 'where.applicationId.nin', 'where.applicationId.contains', 'where.applicationId.contained', 'where.applicationId.overlaps', 'where.createdAt.eq', 'where.createdAt.neq', 'where.createdAt.gt', 'where.createdAt.gte', 'where.createdAt.lt', 'where.createdAt.lte', 'where.createdAt.like', 'where.createdAt.ilike', 'where.createdAt.in', 'where.createdAt.nin', 'where.createdAt.contains', 'where.createdAt.contained', 'where.createdAt.overlaps', 'where.deploymentId.eq', 'where.deploymentId.neq', 'where.deploymentId.gt', 'where.deploymentId.gte', 'where.deploymentId.lt', 'where.deploymentId.lte', 'where.deploymentId.like', 'where.deploymentId.ilike', 'where.deploymentId.in', 'where.deploymentId.nin', 'where.deploymentId.contains', 'where.deploymentId.contained', 'where.deploymentId.overlaps', 'where.id.eq', 'where.id.neq', 'where.id.gt', 'where.id.gte', 'where.id.lt', 'where.id.lte', 'where.id.like', 'where.id.ilike', 'where.id.in', 'where.id.nin', 'where.id.contains', 'where.id.contained', 'where.id.overlaps', 'where.machineId.eq', 'where.machineId.neq', 'where.machineId.gt', 'where.machineId.gte', 'where.machineId.lt', 'where.machineId.lte', 'where.machineId.like', 'where.machineId.ilike', 'where.machineId.in', 'where.machineId.nin', 'where.machineId.contains', 'where.machineId.contained', 'where.machineId.overlaps', 'where.status.eq', 'where.status.neq', 'where.status.gt', 'where.status.gte', 'where.status.lt', 'where.status.lte', 'where.status.like', 'where.status.ilike', 'where.status.in', 'where.status.nin', 'where.status.contains', 'where.status.contained', 'where.status.overlaps', 'where.or', 'orderby.applicationId', 'orderby.createdAt', 'orderby.deploymentId', 'orderby.id', 'orderby.machineId', 'orderby.status']
  const searchParams = new URLSearchParams()
  if (request) {
    queryParameters.forEach((qp) => {
      const queryValue = request?.[qp]
...
async function _updateInstances (url, request) {
  const queryParameters = ['fields', 'where.applicationId.eq', 'where.applicationId.neq', 'where.applicationId.gt', 'where.applicationId.gte', 'where.applicationId.lt', 'where.applicationId.lte', 'where.applicationId.like', 'where.applicationId.ilike', 'where.applicationId.in', 'where.applicationId.nin', 'where.applicationId.contains', 'where.applicationId.contained', 'where.applicationId.overlaps', 'where.createdAt.eq', 'where.createdAt.neq', 'where.createdAt.gt', 'where.createdAt.gte', 'where.createdAt.lt', 'where.createdAt.lte', 'where.createdAt.like', 'where.createdAt.ilike', 'where.createdAt.in', 'where.createdAt.nin', 'where.createdAt.contains', 'where.createdAt.contained', 'where.createdAt.overlaps', 'where.deploymentId.eq', 'where.deploymentId.neq', 'where.deploymentId.gt', 'where.deploymentId.gte', 'where.deploymentId.lt', 'where.deploymentId.lte', 'where.deploymentId.like', 'where.deploymentId.ilike', 'where.deploymentId.in', 'where.deploymentId.nin', 'where.deploymentId.contains', 'where.deploymentId.contained', 'where.deploymentId.overlaps', 'where.id.eq', 'where.id.neq', 'where.id.gt', 'where.id.gte', 'where.id.lt', 'where.id.lte', 'where.id.like', 'where.id.ilike', 'where.id.in', 'where.id.nin', 'where.id.contains', 'where.id.contained', 'where.id.overlaps', 'where.machineId.eq', 'where.machineId.neq', 'where.machineId.gt', 'where.machineId.gte', 'where.machineId.lt', 'where.machineId.lte', 'where.machineId.like', 'where.machineId.ilike', 'where.machineId.in', 'where.machineId.nin', 'where.machineId.contains', 'where.machineId.contained', 'where.machineId.overlaps', 'where.status.eq', 'where.status.neq', 'where.status.gt', 'where.status.gte', 'where.status.lt', 'where.status.lte', 'where.status.like', 'where.status.ilike', 'where.status.in', 'where.status.nin', 'where.status.contains', 'where.status.contained', 'where.status.overlaps', 'where.or']
  const searchParams = new URLSearchParams()
  if (request) {
    queryParameters.forEach((qp) => {
      const queryValue = request?.[qp]
...
async function _initApplicationInstance (url, request) {
  ...
  const response = await fetch(`${url}/pods/${request.machineId}/instance`, {
    method: 'POST',
    body: isFormData ? body : JSON.stringify(body),
    headers,
    ...defaultFetchParams
