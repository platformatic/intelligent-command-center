...
module.exports = fp(async function (app) {
  ...
  // and replace its candidate suggestions. Regeneration otherwise runs once per UTC day from the
  // leader (plugins/scheduler.js → updateAllPredictions); this is the manual trigger.
